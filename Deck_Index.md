...
| Mass Production        | Baylen, the Haymaker        | Naya   |     15/20 | Go-wide tokens / overrun    | **Built & promoted 2026-07-11; Akroma swap 2026-07-17** (fully-owned zero-contention build — no seat freed, roster 16→17; sleeved `mass-production-owned-20260717.txt` after 4 phantom-CSV cards swapped for Akroma's Will/Memorial + Caryatid + Stroke; 2/3 GC Smothering Tithe/Survival; Clock decap T7 / table T10, lab `mp_clock_lab.py` 2026-07-17; wipe-recovery +2/+3 measured; pod gauntlet P(win) 57% #4/17 pre-swap; vs Ur-Dragon 51% best-of-combat; premium draft archived) |
...
- **Solid (13–16):** 7 decks (incl. Zero-Sum Game 16 + Forced Liquidation 16, built 2026-07-08, **Creative Destruction 15** built 2026-07-11, and **Mass Production 15** promoted 2026-07-11 — a NEW seat, no retirement; re-audit both after first pod games).
- **Developing (9–12):** 0.
- **Unscored:** 0.
- **Active roster:** 17 decks.
