...
def test_kill_tree_every_encoded_deck_resolves():
    ...
    are encoded (Diminishing Returns retired 2026-07-08, Earthbend the Meta 2026-07-11;
    Creative Destruction promoted 2026-07-11, Mass Production promoted 2026-07-11);
