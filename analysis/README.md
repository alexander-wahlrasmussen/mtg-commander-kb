...
| `Definitive_Tier_List_2026-06-28.md` | **(current)** ranked tier list of the 17 active decks = composite of the THREE convergent OUTCOME oracles ANTI-POD · INTERACTION · SELF-META (`tier_list.py`), CC demoted to a context column; reconciles where the external-pod vs mirror bars disagree; Forced Liquidation debuts #3 (A, no weak axis); headline: the two 19/20 decks (Lightning War, Dark Lord) rank 12th–13th — score ⊥ winning |
