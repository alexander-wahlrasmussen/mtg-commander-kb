...
| 7 | Ms. Bumbleflower | 16 | T8 / T11 | 15% | 52% | 42% | 39% | **46%** | **Soft on the race, better at the table.** decap T8 is goldfish-optimistic; thin protect. 2026-07-03 quiet-exits package (+Approach/+Alarm/+Wizard Class) doubles the table front edge (T10 17→35%) and adds a wipe-proof, Abolisher-proof close — the anti-pod BLEND barely moves (decap-raced), the mirror/table game is where it shows. |
