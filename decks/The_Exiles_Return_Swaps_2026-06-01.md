...
> `scripts/er_speed_lab.py` (40k trials, `analysis/Exiles_Return_Speed_Curve_Analysis.md`) ran this exact 2-for-2 as a variant against the current list. The swap **slows the goldfish, it does not compress the window**:
>
