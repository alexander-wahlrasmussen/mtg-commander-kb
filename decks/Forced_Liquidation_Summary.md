...
> Build ground truth: `decks/forced-liquidation-20260707.txt` (promoted from `considering/` to the active roster 2026-06-28; interaction swap 2026-07-07 −Blasphemous Act/Deflecting Swat/Drown in the Loch +Abrade/Deadly Tempest/Spell Pierce, `-20260625` archived). Proposal: `archive/proposals/PROP_Kefka_Court_Mage.md` (archived 2026-07-10 — deck built & assembled). Buy list: `analysis/Buy_List_ZeroSum_LightningWar_ForcedLiquidation_2026-06-25.md`.
>
