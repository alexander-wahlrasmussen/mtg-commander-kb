...
| `*_Summary.md` | Deck summary — one per active deck | `decks/` | `decks/The_Genome_Project_Summary.md` |
| `<deck-kebab>-YYYYMMDD*.txt` | Decklist — dated, Moxfield-format | `decks/` | `decks/the-genome-project-20260510.txt` |
...
- **Never modify a `.txt` decklist without bumping the date in the filename.** The dated filename is the version history. If you change `the-exiles-return-20260417-194010.txt`, rename it `the-exiles-return-<today>.txt` and move the old version to `archive/old_decklists/`.
...
```
decks/
├── the-genome-project-20260510.txt
├── The_Genome_Project_Summary.md
